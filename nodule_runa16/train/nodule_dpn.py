...
from src.ResNet import DPN26, DPN92
...
parser.add_argument('--batchSize_train', type=int, default=16, help='the number of neighbourhood to consider')
...
# r3d = generate_model(model_depth=18, n_input_channels=1, n_classes=5)
...
cnn = DPN26()
nodule_net = ResNet3DNodule64x64RegressRegular(cnn)
