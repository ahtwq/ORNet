...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=5, zero_init_residual=False, norm_layer=None,
                 multitask=True, liu=False, chen=False, CAN_TS=False, crossCBAM=True,
                 crosspatialCBAM= False,  choice="both"):
...
def CANetResNet50(pretrained=True, **kwargs):
